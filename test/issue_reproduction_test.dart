...
void main() {
  group('Issue Reproduction Tests', () {
    ...
    testWidgets('Issue #3: Markdown enabled should still show animation', (WidgetTester tester) async {
      ...
      expect(animationCompleted, isTrue, reason: 'Markdown animation should complete successfully');
    });

    // Test for Issue #1: Animation restart bug with streaming
    testWidgets('Issue #1: New text should animate only new content', (WidgetTester tester) async {
    ...
    testWidgets('Markdown should render while animating', (WidgetTester tester) async {
      ...
      // Should complete
      expect(completed, isTrue, reason: 'StreamingTextMarkdown should complete animation');
    });

    // Test for LaTeX integration (Issue #2 - already addressed)
    testWidgets('LaTeX expressions should render correctly', (WidgetTester tester) async {
